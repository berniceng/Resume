            ...
            <div>
              ...
              <div className={styles.card}>
                ...
                <div>
                  ...
                  <div>
                    Back then when I started the semester in polytechnic, I was worried that 
                    I might not be able to do well. I didn't know how to type. I even used one finger 
                    to type and was really slow at it. I didn't started off as a fan of coding but 
                    when I was exposed to it, my interest grew. It became something that i would want 
                    as a job now and that something that I would want to learn more and more.
                  </div>
                </div>
              </div>
            </div>
